...
def test_ur_delivery_auth(app, settings):
    ...
    app.order_delivery_ur.select_day2()
    ...
    app.order_delivery_ur.input_email_ur(email="info@kluatr.ru")
...
def test_fiz_self_auth(app, settings):
    ...
    app.order_self_fiz.input_email_fiz(email="info@kluatr.ru")
...
def test_ur_self_auth(app, settings):
    ...
    app.order_self_ur.input_email_ur(email="info@kluatr.ru")
